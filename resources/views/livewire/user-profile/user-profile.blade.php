<div x-data="{ activeTab: @entangle('activeTab') }">
      ...
      <div class="row gx-4">
        ...
        <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
          <div class="nav-wrapper position-relative end-0">
            <ul class="nav custom-profile-tabs nav-fill p-1 bg-transparent" role="tablist" style="gap: 0.5rem;">
              <li class="nav-item">
                <button type="button" class="nav-link mb-0 px-0 py-1 border-0 bg-transparent"
                  :class="{ 'profile-tab-active': activeTab === 'overview', 'text-secondary': activeTab !== 'overview' }"
              ...
              <li class="nav-item">
                <button type="button" class="nav-link mb-0 px-0 py-1 border-0 bg-transparent"
                  :class="{ 'profile-tab-active': activeTab === 'teams', 'text-secondary': activeTab !== 'teams' }"
                  @click="activeTab = 'teams'; $wire.setActiveTab('teams')"
                  style="cursor: pointer; transition: all 0.3s ease;">
              ...
              <li class="nav-item">
                <button type="button" class="nav-link mb-0 px-0 py-1 border-0 bg-transparent"
                  :class="{ 'profile-tab-active': activeTab === 'projects', 'text-secondary': activeTab !== 'projects' }"
                  @click="activeTab = 'projects'; $wire.setActiveTab('projects')"
                  style="cursor: pointer; transition: all 0.3s ease;">
  ...
  <div class="container-fluid py-4">
    ...
    <div x-show="activeTab === 'overview'">
      <livewire:user-profile.user-profile-overview :usuario="$usuario" />
    </div>
  ...
  <style>
    ...
    .profile-tab-active .color-background {
